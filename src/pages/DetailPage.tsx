...
import { prenotationData } from "../firebase-config";
...
const DetailPage = () => {
    ...
    const [prenotationName, setName] = useState<string>("");
    const [time, setTime] = useState<string>("");
    const [prenotationID, setID] = useState<number>(0);
    ...
    const handleButtonClick = (index: number) => {
        if (isMounted) {
            const updatedPrenotation: PrenotationItem[] = prenotation.map(
                (item, i) => ({
                    ...item,
    ...
    return (
        <div className="bg-white rounded-lg shadow p-3 m-8  relative">
            <div className="text-black">
                ...
                />
                <h1 className="text-2xl font-bold mb-2 bg-gray-200 px-3 py-1">
                    {name}
                </h1>
            </div>
            <div className="text-black">
                        ...
                        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            <div className="bg-white p-6 rounded-lg">
                                ...
                                <p>
                                    ...
                                    {modalFormData.name}{" "}
                                    <strong> for your prenotation</strong>
                                </p>
                                <p>
                                    <strong>We have sent a mail to :</strong>{" "}
                                    {modalFormData.email}{" "}
                                    <strong>
                                        {" "}
                                        with all the the details of your
                                        reservation
                                    </strong>
                                </p>
                                <button
